  ...
  <main id="About">
    <div class="parent" id="content-container">
      <div class="div1">
        ...
        <p>This website is for river boat spotters in the Quad Cites. It works by collecting each vessel's radio transponder data which is parsed, stored and shown on a map.  You can then use this information to estimate when a riverboat will pass near by.</p>
