...
import { faBars, faThumbsUp, faThumbsDown, faCaretRight, faCaretUp, faCaretDown } from '@fortawesome/free-solid-svg-icons'
 



library.add(faBars, faThumbsUp, faThumbsDown, faCaretRight, faCaretUp, faCaretDown);
