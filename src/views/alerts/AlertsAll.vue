...
<transition-group enter-active-class="animate__animated animate__slideInRight">
      <li class="card" v-if="this.$store.state.a.alertsAll[19].apubID >-1" :key="this.$store.state.a.alertsAll[19].apubID">
...
<transition-group enter-active-class="animate__animated animate__slideInDown">
      <li class="card" v-if="this.$store.state.a.alertsAll[17].apubID >-1" :key="this.$store.state.a.alertsAll[17].apubID">
...
<transition-group enter-active-class="animate__animated animate__slideInDown">
      <li class="card" v-if="this.$store.state.a.alertsAll[16].apubID >-1" :key="this.$store.state.a.alertsAll[16].apubID">
...
<transition-group enter-active-class="animate__animated animate__slideInDown">
      <li class="card" v-if="this.$store.state.a.alertsAll[15].apubID >-1" :key="this.$store.state.a.alertsAll[15].apubID">
...
<transition-group enter-active-class="animate__animated animate__slideInDown">
      <li class="card" v-if="this.$store.state.a.alertsAll[14].apubID >-1" :key="this.$store.state.a.alertsAll[14].apubID">
...
<transition-group enter-active-class="animate__animated animate__slideInDown">
      <li class="card" v-if="this.$store.state.a.alertsAll[13].apubID >-1" :key="this.$store.state.a.alertsAll[13].apubID">
...
<transition-group enter-active-class="animate__animated animate__slideInDown">
      <li class="card" v-if="this.$store.state.a.alertsAll[12].apubID >-1" :key="this.$store.state.a.alertsAll[12].apubID">
...
<transition-group enter-active-class="animate__animated animate__slideInDown">
      <li class="card" v-if="this.$store.state.a.alertsAll[11].apubID >-1" :key="this.$store.state.a.alertsAll[11].apubID">
...
<transition-group enter-active-class="animate__animated animate__slideInDown">
      <li class="card" v-if="this.$store.state.a.alertsAll[10].apubID >-1" :key="this.$store.state.a.alertsAll[10].apubID">
...
<transition-group enter-active-class="animate__animated animate__slideInDown">
      <li class="card" v-if="this.$store.state.a.alertsAll[9].apubID >-1" :key="this.$store.state.a.alertsAll[9].apubID">
...
<transition-group enter-active-class="animate__animated animate__slideInDown">
      <li class="card" v-if="this.$store.state.a.alertsAll[8].apubID >-1" :key="this.$store.state.a.alertsAll[8].apubID">
...
<transition-group enter-active-class="animate__animated animate__slideInDown">
      <li class="card" v-if="this.$store.state.a.alertsAll[7].apubID >-1" :key="this.$store.state.a.alertsAll[7].apubID">
...
<transition-group enter-active-class="animate__animated animate__slideInDown">
      <li class="card" v-if="this.$store.state.a.alertsAll[6].apubID >-1" :key="this.$store.state.a.alertsAll[6].apubID">
...
<transition-group enter-active-class="animate__animated animate__slideInDown">
      <li class="card" v-if="this.$store.state.a.alertsAll[5].apubID >-1" :key="this.$store.state.a.alertsAll[5].apubID">
...
<transition-group enter-active-class="animate__animated animate__slideInDown">
      <li class="card" v-if="this.$store.state.a.alertsAll[4].apubID >-1" :key="this.$store.state.a.alertsAll[4].apubID">
...
<transition-group enter-active-class="animate__animated animate__slideInDown">
      <li class="card" v-if="this.$store.state.a.alertsAll[3].apubID >-1" :key="this.$store.state.a.alertsAll[3].apubID">
...
<transition-group enter-active-class="animate__animated animate__slideInDown">
      <li class="card" v-if="this.$store.state.a.alertsAll[2].apubID >-1" :key="this.$store.state.a.alertsAll[2].apubID">
...
<transition-group enter-active-class="animate__animated animate__slideInDown">
    <li class="card" v-if="this.$store.state.a.alertsAll[1].apubID >-1" :key="this.$store.state.a.alertsAll[1].apubID">
...
<transition-group enter-active-class="animate__animated animate__slideInDown">
    <li class="card" v-if="this.$store.state.a.alertsAll[0].apubID >-1" :key="this.$store.state.a.alertsAll[0].apubID">
